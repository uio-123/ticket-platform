package com.ticketing.item.service.impl;
...
import com.ticketing.item.mapper.ItemMapper;
import com.ticketing.item.service.IItemService;
...
public class ItemServiceImpl extends ServiceImpl<ItemMapper, Item> implements IItemService {
    ...
    public void deductStock(List<OrderDetailDTO> items) {
        String sqlStatement = "com.ticketing.item.mapper.ItemMapper.updateStock";
        boolean r = false;
        try {
